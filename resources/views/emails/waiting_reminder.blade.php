...
<table align="center" cellpadding="0" cellspacing="0" width="600"
    ...
    <tr>
        <td style="padding:30px; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); text-align: center;">
            ...
            <h2 style="margin:10px 0 0 0; font-weight:700; color:white; font-size: 20px;">⚠️ Важливе нагадування</h2>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:30px; color: rgba(255, 255, 255, 0.9);">
            ...
            <p style="margin:0 0 15px; color: rgba(255, 255, 255, 0.7);"><strong style="color: #f59e0b;">Клієнт:</strong> {{ $project->client?->name ?? '—' }}</p>
            <p style="margin:0 0 15px; color: rgba(255, 255, 255, 0.7);"><strong style="color: #f59e0b;">Назва проєкту:</strong> {{ $project->name }}</p>

            <p style="margin:0 0 20px; color: rgba(255, 255, 255, 0.5); font-size: 13px;">Дата: {{ now()->format('d.m.Y H:i') }}</p>

            <div style="background: rgba(245, 158, 11, 0.2); border-left: 3px solid #f59e0b; padding: 15px; border-radius: 8px; margin: 20px 0;">
                <p style="font-size:15px; line-height:1.6; color: rgba(255, 255, 255, 0.9); margin: 0;">
                    <strong>Увага!</strong> Проєкт очікує на вашу відповідь. Нагадуємо, що на даному етапі нам потрібна ваша відповідь або затвердження,
            ...
            <div style="text-align: center; margin: 25px 0;">
                <a href="https://clients.smarto.agency/projects/{{ $project->id }}"
                   style="display: inline-block; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: white; text-decoration: none; padding: 12px 30px; border-radius: 12px; font-weight: 600;">
                    Відкрити проєкт →
                </a>
            </div>
    ...
    <tr>
        <td style="padding:20px 30px; background:rgba(13, 13, 13, 0.6); font-size:12px; color: rgba(255, 255, 255, 0.5); text-align:center; border-top: 1px solid rgba(245, 158, 11, 0.2);">
            Відправлено автоматично з системи <strong style="color: #f59e0b;">Smarto Agency</strong>
        </td>
    </tr>
</table>
</body>

...
<head>
    ...
    <title>Smarto Agency - Client Dashboard</title>
    ...
    <style>
        * {
        ...
        .hero-container::before {
            ...
            bottom: 0;
            background-image: 
                linear-gradient(90deg, rgba(255, 72, 0, 0.03) 1px, transparent 1px),
                linear-gradient(rgba(255, 72, 0, 0.03) 1px, transparent 1px);
        ...
        @keyframes glow {
            from {
                text-shadow: 0 0 20px rgba(255, 72, 0, 0.5),
                             0 0 40px rgba(255, 72, 0, 0.3);
            }
            to {
                text-shadow: 0 0 30px rgba(255, 72, 0, 0.8),
                             0 0 60px rgba(255, 72, 0, 0.5);
            }
        }
        ...
        .cta-button {
            ...
            font-size: 1.1rem;
            transition: all 0.3s ease;
            box-shadow: 0 10px 40px rgba(255, 72, 0, 0.3);
            letter-spacing: 1px;
        }

        .cta-button:hover {
            transform: translateY(-5px);
            box-shadow: 0 15px 50px rgba(255, 72, 0, 0.5);
        }
        ...
        .float-element {
            position: absolute;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(255, 72, 0, 0.2) 0%, transparent 70%);
